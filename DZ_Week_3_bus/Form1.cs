    ...
    public partial class Form1 : Form
    {
      ...
      List<Route> routes = new List<Route>();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            routes.Add(new Route(8, "40местный", "Ростов", new DateTime(2022, 11, 29), new TimeSpan(15, 15, 0), new DateTime(2022, 12, 15), new TimeSpan(16, 45, 0)));
            routes.Add(new Route(9, "40местный", "Ростов", new DateTime(2022, 11, 29), new TimeSpan(17, 15, 0), new DateTime(2022, 12, 16), new TimeSpan(18, 45, 0)));
